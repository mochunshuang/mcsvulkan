...
try
{
    ...
    // diff: [base_min_max_width_height] start
    /*
...
*/
    Node screen{
        ...
        Node{
            ...
            Node{"child0", Style{.margin = {5_px}, .height = {25_px}}},
            Node{"child1",
                 Style{.margin = {5_px}, .max_height = {25_px}, .height = {100_px}}},
            Node{"child2",
                 Style{.margin = {5_px}, .min_height = {50_px}, .height = {25_px}}},
            Node{"child3",
                 Style{.margin = {5_px}, .max_width = {25_px}, .height = {25_px}}},
            Node{"child4", Style{.margin = {5_px},
                                 .min_width = {50_px},
                                 .width = {25_px},
                                 .height = {25_px}}},
        }};
    ...
    // diff: [base_min_max_width_height] end
