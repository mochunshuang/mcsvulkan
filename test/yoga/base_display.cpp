...
*/
    Node screen{"screen", Style{.width = {Pixels{WIDTH}}, .height = {Pixels{HEIGHT}}},
                Node{
                    "root",
                    ...
                    Node{"child0", Style{.display = {YGDisplay::YGDisplayNone},
                                         .margin = {5_px},
                                         .height = {50_px}}},
                    Node{"child1", Style{.display = {YGDisplay::YGDisplayFlex},
                                         .margin = {5_px},
                                         .height = {50_px}}},
                }};
    // diff: [base_display] end
