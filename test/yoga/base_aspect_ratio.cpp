...
*/
    Node screen{
        ...
        Node{
            ...
            Node{"child0",
                 Style{.aspect_ratio = {1.0F}, .margin = {5_px}, .height = {50_px}}},
            Node{"child1",
                 Style{.aspect_ratio = {1.5F}, .margin = {5_px}, .height = {50_px}}},
        }};
    // diff: [base_aspect_ratio] end
