...
*/
    Node screen{"screen",
                ...
                Node{
                    ...
                    Node{"child0", Style{.width = {50_px}, .height = {50_px}}},
                    Node{"child1", Style{.width = {50_px}, .height = {50_px}}},
                    Node{"child2", Style{.width = {50_px}, .height = {50_px}}},
                    Node{"child3", Style{.width = {50_px}, .height = {50_px}}},
                    Node{"child4", Style{.width = {50_px}, .height = {50_px}}},
                }};
