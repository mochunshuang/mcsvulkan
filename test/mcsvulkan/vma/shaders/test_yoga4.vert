...
struct VertexData{
    ...
    uint modulateFlag;//diff: [test_emoji] 0 = 不调制, 1 = 调制 (或其他非0值)
};
...
layout(push_constant,scalar)uniform PushConstants{
    ...
    mat4 model;//diff: [test_yoga4] 移到上面这是模型矩阵
}pc;
...
layout(location=6)out flat uint modulateFlag;//diff: [test_emoji]
