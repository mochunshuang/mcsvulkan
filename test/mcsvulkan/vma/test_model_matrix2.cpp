...
struct mesh_base
{
    ...
    static void updateObjectData(FrameBuffers &fb, const object_data &data) noexcept
    {
    ...
    const auto recordCommandBuffer = [&](const CommandBufferView &commandBuffer,
...

        {
            ...
            mesh_base::updateObjectData(
                input_mesh.frameBuffers[currentFrame],
        ...
        }
        {
            ...
            mesh_base::updateObjectData(
                input_mesh2.frameBuffers[currentFrame],
                {glm::rotate(glm::mat4(1.0F), time * glm::radians(10.0F),
                             glm::vec3(0.0F, 0.0F, 1.0F))});
            // diff: [test_model_matrix2] end
