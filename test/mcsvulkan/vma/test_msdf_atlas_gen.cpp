    ...
    */
    ...
    class FontLibrary
    {
      ...
      public:
        ...
        glyph_info getGlyph(char32_t unicode) const
        {
...
try
{
    ...
    constexpr auto CHAR = U'e'; // NOTE: 注意有参数耦合着色器
    ...
    font_lib.load(font::FontType::eMSDF, 0, 0, // textureIndex=0, samplerIndex=0
                  ...
                  JSON_PATH_0);
    font_lib.load(font::FontType::eMSDF, 1, 0, // 第二个字体用 textureIndex=1
    ...
    std::mt19937 gen(rd());
    std::uniform_int_distribution<> textureDis(0, TEXTURE_COUNT - 1);
