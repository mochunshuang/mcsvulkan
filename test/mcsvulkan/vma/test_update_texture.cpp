...
*/
    ...
    textures_copy.reserve(TEXTURE_COUNT);
    ...
    auto updateTextureDynamic = [](const LogicalDevice &device,
                                   VkDescriptorSet descriptorSet,
                                   uint32_t textureIndex, // 要更新的纹理索引
                                   const TextureImage &newTexture,
                                   std::vector<VkDescriptorImageInfo> &textureInfos) {
        // 更新指定纹理索引的纹理信息
        textureInfos[textureIndex] = VkDescriptorImageInfo{
            .sampler = nullptr,
        ...
        VkWriteDescriptorSet write = {.sType = sType<VkWriteDescriptorSet>(),
                                      .dstSet = descriptorSet,
                                      .dstBinding = 1, // 纹理绑定是binding 1
                                      .dstArrayElement =
                                          textureIndex, // 更新数组中指定索引的元素
                                      .descriptorCount = 1,
                                      .descriptorType = VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,
                                      .pImageInfo = &textureInfos[textureIndex]};
