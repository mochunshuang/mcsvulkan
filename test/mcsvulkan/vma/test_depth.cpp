...
using mcs::vulkan::vma::create_depth_resources;
...
static_assert(sizeof(Vertex) == 24, "check sizeof error");
...
try
{
        ...
        create_depth_resources{device, allocator}
            .setCreateInfo(
                {.imageType = VK_IMAGE_TYPE_2D,
                 .format = create_depth_resources::findSupportedFormat(
                     physical_device,
    ...
    const std::vector<Vertex> vertices = {
        {{-0.5f, -0.5f, 0}, {1.0f, 0.0f, 0.0f}}, // 左下
        {{0.5, -0.5, 0}, {0.0f, 1.0f, 0.0f}},    // 右下
        {{0.5, 0.5, 0}, {0.0f, 0.0f, 1.0f}},     // 右上
        {{-0.5, 0.5, 0}, {1.0f, 0.0f, 0.0f}}     // 左上
    };
        ...
        if (now - lastUpdate > std::chrono::seconds(1)) // NOLINT
        {
            ...
            if (isTriangle)
            {
                ...
                static const std::vector<Vertex> VERTICES = {
                    {{-0.5f, -0.5f, 0.7}, {1.0f, 0.0f, 0.0f}},
                    {{0.5f, -0.5f, 0.7}, {0.0f, 1.0f, 0.0f}},
                    {{0.0f, 0.5f, 0.7}, {0.0f, 0.0f, 1.0f}}};
