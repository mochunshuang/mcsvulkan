                    ...
                    if (unicode == glyph.unicode)
                    {
                        ...
                        if (!atlasBounds)
                            ...
                            return {.type = atlas.type,
                                    .texture_index = atlas.texture_index,
                                    .sampler_index = atlas.sampler_index,
                                    .uv_bounds = {.left = 0,
                                                  .bottom = 0,
                                                  .right = 0,
                                                  .top = 0},
...
try
{
    ...
    for (char32_t ch : text)
    {
        ...
        double distanceRange = info.font_ctx->atlas.distanceRange.value_or(0);
        ...
        // 更新光标：使用字体的 advance 前进量
        static float advance = 0.1;
        cursorX += advance;
        if (ch == ' ')
            advance = 0.45;
        if (ch == U'的')
