...
*/
    ...
    */
    ...
    std::u32string text = U"Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
                          U"سلام的😅Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
                          U"سلام的😅Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
                          U"سلام的😅Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
                          U"سلام的😅Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
                          U"سلام的😅Hello سلام的😅Hello سلام的😅Hello سلام的😅Hello "
...
// diff: [test_libunibreak] start
    ...
    for (const auto &line : lines)
    {
        visualLines.push_back(
            reorder_line(line.glyphs, line.startChar, line.endChar, bidi.levels));
    }
